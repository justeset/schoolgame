...
/** @type {string} */
const CACHE_VERSION = '1775246738|5289457575';
/** @type {string} */
const CACHE_PREFIX = 'school21_game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'school21_game_v1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["school21_game_v1.html","school21_game_v1.js","school21_game_v1.offline.html","school21_game_v1.icon.png","school21_game_v1.apple-touch-icon.png","school21_game_v1.audio.worklet.js","school21_game_v1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["school21_game_v1.wasm","school21_game_v1.pck"];
