...
/** @type {string} */
const CACHE_VERSION = '1776447493|21634978520';
/** @type {string} */
const CACHE_PREFIX = 'school21_game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'school21_game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["school21_game.html","school21_game.js","school21_game.offline.html","school21_game.icon.png","school21_game.apple-touch-icon.png","school21_game.audio.worklet.js","school21_game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["school21_game.wasm","school21_game.pck"];
